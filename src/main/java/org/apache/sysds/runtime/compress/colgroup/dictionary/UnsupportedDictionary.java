 ...
 * It is intended to be used as a base for other dictionaries that do not support all operations.
 */
public class UnsupportedDictionary implements IDictionary, Serializable {

	private static final long serialVersionUID = 1L;

	private final String message;

	public UnsupportedDictionary(String message) {
